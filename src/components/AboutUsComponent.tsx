      ...
      <Flex  style={{ flex: 1 }} gap={20}>
        <Flex className="left-side" style={{ flex: 1 }} direction="column">
          ...
          <div className={classes.flexContent}>
            <h2>Пирожное</h2>
            <p>
              Мы специализируемся на создании непревзойденных пирожных, которые
              покорят ваше воображение и удовлетворят самые изысканные вкусы.
              Наша миссия - приготовить для вас настоящие шедевры кондитерского
              искусства.
            </p>
          </div>
        ...
        >
          ...
          <div className={classes.flexContent}>
            ...
            <p>
              ...
              изысканные предпочтения наших клиентов. Независимо от того, какие
              предпочтения вы имеете, у нас есть торт, который подарит вам
